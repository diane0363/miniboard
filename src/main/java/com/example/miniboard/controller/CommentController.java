...
public class CommentController {
    ...
    public String create(@PathVariable("postId") Long postId,
        ...
        CommentResponse created = commentService.create(
                postId, request.getParentId(), request.getContent(), principal.getUserId());
    ...
    public ResponseEntity<String> delete(@PathVariable("commentId") Long commentId,
        ...
        boolean keepAsPlaceholder = commentService.delete(commentId, principal.getUserId());
    ...
    private String renderFragment(String fragment, Model model) {
        // ★ 주의: 여기서 Context는 org.thymeleaf.context.Context 입니다.
